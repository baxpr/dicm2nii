function varargout = dicm2nii_anon(src, niiFolder, fmt)
...
%% user preference
pf.save_patientName = false; %getpref('dicm2nii_gui_para', 'save_patientName', true);
pf.save_json        = true; %getpref('dicm2nii_gui_para', 'save_json', false);
pf.use_parfor       = false; %getpref('dicm2nii_gui_para', 'use_parfor', true);
pf.use_seriesUID    = false; %getpref('dicm2nii_gui_para', 'use_seriesUID', true);
pf.lefthand         = true; %getpref('dicm2nii_gui_para', 'lefthand', true);
pf.scale_16bit      = false; %getpref('dicm2nii_gui_para', 'scale_16bit', false);
...
for i = 1:nRun
    ...
    h{i}{1}.AcquisitionDateTime = '';
    h{i}{1}.SeriesDescription = ProtocolName(h{i}{1});
...
flds = { % store for nii.ext and json
  ...
  'TaskName' 'bval' 'bvec' 'VolumeTiming' ...
